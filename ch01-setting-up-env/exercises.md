# Exercises
1. [x] Take the "Hello, world!" program and run it on The Go Playground.
   Share a link to the code in the playground with a coworker who would love to learn about Go.
2. [x] Add a target to he Makefile called `clean` that removes the `hello_world` binary
...
3. [x] Experiment with modifying the formatting in the "Hello, world!" program.
